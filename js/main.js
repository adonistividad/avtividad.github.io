jQuery(document).ready(function($) {
    ...
    function initializes() {
        ...
        var mapOptions = {
            zoom: 16,
            center: new google.maps.LatLng(25.270711, 55.323347),
            mapTypeId: google.maps.MapTypeId.ROADMAP
        }
        var map = new google.maps.Map(document.getElementById("map_canvas"), mapOptions);
        var marker = new google.maps.Marker({
            position: new google.maps.LatLng(25.270711, 55.323347),
            map: map,
            title: 'Muteena Building, Salahuddin Road, Deira, Dubai, United Arab Emirates.',
